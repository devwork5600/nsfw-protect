          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg bg-white/2 border-white/10">
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-white/10 flex items-center justify-center font-bold text-xs">G</div>
                <div>
              ...
              <Badge variant="outline" className="text-green-500 border-green-500/30 uppercase tracking-widest text-[10px]">Active</Badge>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg bg-white/2 border-white/10">
              ...
              <Badge variant="outline" className="text-green-500 border-green-500/30 uppercase tracking-widest text-[10px]">Enabled</Badge>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg bg-primary/5 border-primary/20">
              ...
              <Badge variant="outline" className="text-muted-foreground border-muted-foreground/30 uppercase tracking-widest text-[10px]">Disabled</Badge>
            </div>
            <Button onClick={handleEnable2FA} variant="outline" className="font-heading uppercase tracking-widest text-xs font-bold w-full">Enable 2FA</Button>
          </CardContent>
        </Card>
              ...
              <div className="flex items-center justify-between text-sm border-b pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">San Francisco, USA • 192.168.1.1</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">San Francisco, USA • 192.168.1.2</p>
                  </div>
                </div>
