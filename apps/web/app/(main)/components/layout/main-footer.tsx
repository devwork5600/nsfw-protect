...
const MainFooter = () => {
  return (
    <footer className="border-t border-border bg-card py-12 mt-12">
      <div className="container mx-auto max-w-360 px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-wrap gap-6 text-sm font-medium text-muted-foreground uppercase font-heading tracking-widest">
