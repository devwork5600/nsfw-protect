      ...
      <div className="flex-1 w-full xl:max-w-3xl space-y-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <h1 className="text-4xl font-heading font-bold tracking-tighter text-foreground">Batch Processing</h1>
            <Badge variant="outline" className="rounded-none border-primary/50 text-primary font-heading text-[10px] uppercase tracking-widest">Coming Soon</Badge>
          </div>
          <p className="text-lg text-muted-foreground font-sans leading-relaxed">
            Batch processing will allow you to submit multiple images in a single API call for asynchronous classification. Ideal for content moderation pipelines and bulk media imports.
          </p>
        </div>
        <div className="border border-primary/30 bg-primary/5 p-6 space-y-3">
          <h4 className="font-heading uppercase tracking-widest text-sm font-bold text-primary">Planned Features</h4>
