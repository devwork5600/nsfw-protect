            ...
            {isClassifying && (
              <div className="space-y-8">
                <div className="flex flex-col items-center text-center gap-4 py-4">
                  <div className="size-20 bg-accent rounded-full animate-pulse" />
                  <div className="space-y-2 flex flex-col items-center">
                    <div className="h-6 w-32 bg-accent rounded-full animate-pulse" />
                    <div className="h-4 w-48 bg-accent animate-pulse rounded" />
                  </div>
                </div>

                <div className="space-y-4">
                  <div className="h-3 w-16 bg-accent animate-pulse rounded border-b pb-2" />
                  {[1, 2].map((i) => (
                    <div key={i} className="space-y-1.5">
                      <div className="flex justify-between">
                        <div className="h-4 w-16 bg-accent animate-pulse rounded" />
                        <div className="h-4 w-10 bg-accent animate-pulse rounded" />
                      </div>
