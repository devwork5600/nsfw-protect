      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">
              {((stats.usage.nsfwDetections / (stats.usage.imageCount || 1)) * 100).toFixed(1)}%
            </div>
            <p className="mt-2 text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-muted-foreground">API latency: ~120ms</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center text-sm border-b pb-2">
              ...
              <span className="font-bold text-green-600">
                {stats.usage.safeDetections.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center text-sm border-b pb-2">
              <span className="text-muted-foreground">NSFW content blocked</span>
              <span className="font-bold text-destructive">
                {stats.usage.nsfwDetections.toLocaleString()}
              </span>
            </div>
